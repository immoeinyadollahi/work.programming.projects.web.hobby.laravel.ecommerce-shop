(function ($) {
  ...
  $(function () {
    ...
    $(document).on("click", function (event) {
      $(".indicator").not($(event.target).closest(".indicator")).removeClass("indicator--opened");
    });
  });
  ...
  $(function () {
    ...
    CDepartments.prototype.close = function () {
      ...
      this.element.addClass("departments--transition").removeClass("departments--opened");
    ...
    CDepartments.prototype.open = function () {
      ...
      this.element.addClass("departments--transition").addClass("departments--opened");
  ...
  const initProductGallery = function (element, layout) {
    ...
    image.owlCarousel({ items: 1, dots: false, rtl: isRTL() }).on("changed.owl.carousel", syncPosition);
