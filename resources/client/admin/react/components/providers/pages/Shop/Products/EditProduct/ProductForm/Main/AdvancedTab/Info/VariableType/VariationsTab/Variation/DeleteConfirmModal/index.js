...
export default function DeleteConfirmModal({ variation, onClose, onConfirm }) {
    ...
    const handleConfirm = async () => {
        setIsDeleting(true);
        try {
            await variationsHttp.deleteVariation(variation.id);
    ...
    return (
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title>حذف متغیر</Modal.Title>
            </Modal.Header>
            <Modal.Body>
