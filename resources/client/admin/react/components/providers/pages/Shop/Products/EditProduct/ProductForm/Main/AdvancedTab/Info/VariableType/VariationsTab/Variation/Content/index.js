...
export default function Content({ variation, errors, updateVariation }) {
    const initialValues = useMemo(
        () => _.omit(variation, ["id", "attributes"]),
        []
    );
    const formik = useFormik({
        initialValues,
    });
    const updateVariationField = (key, value) => {
        updateVariation((variation) => (variation[key] = value));
    };
    return (
        <div className="mt-10">
            {/*begin::Input group*/}
            <div className="mb-5">
                ...
                <input
                    ...
                    onBlur={(e) =>
                        e.target.value != variation.price &&
                        updateVariationField("price", formik.values.price)
                    }
                />
                {errors.price && (
                ...
                <div className="row">
                    <div className="col-md-6 mb-5">
                        ...
                        <input
                            ...
                            onChange={formik.handleChange}
                            onBlur={(e) =>
                                e.target.value != variation.discounted_price &&
                                updateVariationField(
                                    "discounted_price",
            ...
            <div className="mb-5">
                ...
                <input
                    ...
                    onChange={formik.handleChange}
                    onBlur={(e) =>
                        e.target.value != variation.stock &&
                        updateVariationField("stock", formik.values.stock)
                    }
                />
                {/*end::Input*/}
                {errors.stock && (
            ...
            <div>
                ...
                <textarea
                    ...
                    onChange={formik.handleChange}
                    onBlur={(e) =>
                        e.target.value !== variation.description &&
                        updateVariationField(
                            "description",
