...
@section('page-title', 'لیست ویژگی ها')
@section('page-toolbar-title', 'لیست ویژگی ها')
@section('page-toolbar-breadcrumb')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-dark">لیست ویژگی ها</li>
    <!--end::Item-->
@endsection
        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-ecommerce-category-filter="search"
                            class="form-control form-control-solid w-250px ps-14" placeholder="جستجو ویژگی">
                    </div>
                    <!--end::جستجو-->
                </div>
                <!--end::Card title-->
                ...
                <div class="card-toolbar">
                    <!--begin::Add customer-->
                    <a href="/shop/property-group/{{ $group->id }}/properties/create" class="btn btn-primary">افزودن
                        ویژگی</a>
                    <!--end::Add customer-->
                </div>
                <!--end::Card toolbar-->
            ...
            <div class="card-body pt-0">
                @if ($paginator->isEmpty())
                    <div class="alert alert-primary m-0">در حال حاظر ویژگی برای این گروه ثبت نشده است</div>
                @else
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px">تعداد مقادیر</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($paginator->items() as $property)
                                    ...
                                    <tr>
                                        ...
                                        <!--begin::نام=-->
                                        <td>
                                            <a href="/shop/property/{{ $property->id }}/edit"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1">{{ $property->name }}</a>
                                        </td>
                                        <!--end::نام=-->
                                        <!--begin::تعداد ویژگی ها=-->
                                        <td>
                                            {{ $property->values_count }}
                                        </td>
                                        <!--end::تعداد ویژگی ها=-->
                                        <!--begin::عملیات=-->
                                        <td>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="/shop/property/{{ $property->id }}/delete"
