...
@section('page-vendor-styles')
    <link href="/public/admin/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css">
    <link href="/public/admin/plugins/custom/vis-timeline/vis-timeline.bundle.rtl.css" rel="stylesheet" type="text/css">
@endsection
@section('page-toolbar-title', 'داشبورد')
                ...
                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">درآمد مورد انتظار</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="card-body pt-2 pb-4 d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column content-justify-center w-100">
                            ...
                            <div class="d-flex fs-6 fw-bold align-items-center">
                                ...
                                <!--end::Bullet-->
                                <!--begin::Tags-->
                                <div class="text-gray-500 flex-grow-1 me-4">کفش ها</div>
                                <!--end::Tags-->
                                <!--begin::Stats-->
                            ...
                            <div class="d-flex fs-6 fw-bold align-items-center my-3">
                                ...
                                <!--end::Bullet-->
                                <!--begin::Tags-->
                                <div class="text-gray-500 flex-grow-1 me-4">بازی</div>
                                <!--end::Tags-->
                                <!--begin::Stats-->
                ...
                <div class="card card-flush h-md-50 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">سفارشات این ماه</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="card-body d-flex align-items-end pt-0">
                        ...
                        <div class="d-flex align-items-center flex-column mt-3 w-100">
                            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                <span class="fw-boldest fs-6 text-dark">1048 تا هدف</span>
                ...
                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">میانگین فروش روزانه</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                ...
                <div class="card card-flush h-md-50 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::مقدار-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">مشتریان جدید این ماه</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="card-body d-flex flex-column justify-content-end pe-0">
                        ...
                        <div class="symbol-group symbol-hover flex-nowrap">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="میکائیل احمدی">
                                <img alt="Pic" src="/public/admin/media/avatars/300-11.jpg">
                            </div>
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="میلاد مرادی">
                                <img alt="Pic" src="/public/admin/media/avatars/300-2.jpg">
                            </div>
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="بهروز ازادی">
                                <img alt="Pic" src="/public/admin/media/avatars/300-12.jpg">
                            </div>
                ...
                <div class="card card-flush overflow-hidden h-md-100">
                    ...
                    <div class="card-header py-5">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">فروش این ماه ها</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">کاربران از تمامی کانال ها</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                    ...
                    <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                        ...
                        <div class="px-9 mb-5">
                            ...
                            <!--end::امار-->
                            <!--begin::توضیحات-->
                            <span class="fs-6 fw-bold text-gray-400">اهداف</span>
                            <!--end::توضیحات-->
                        </div>
                        <!--end::امار-->
                        <!--begin::Chart-->
            ...
            <div class="col-xl-6 mb-xl-10">
                ...
                <div class="card h-md-100">
                    ...
                    <div class="card-header align-items-center border-0">
                        <!--begin::Title-->
                        <h3 class="fw-bolder text-gray-900 m-0">سفارشات اخیر</h3>
                        <!--end::Title-->
                        <!--begin::Menu-->
                        <button class="btn btn-icon btn-color-gray-400 btn-active-color-primary justify-content-end"
                            data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
                        ...
                        <ul class="nav nav-pills nav-pills-custom mb-3">
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6">
                                ...
                                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                                    ...
                                    <!--begin::Icon-->
                                    <div class="nav-icon">
                                        <img alt="" src="/public/admin/media/svg/products-categories/t-shirt.svg"
                                            class="">
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <span class="nav-text text-gray-700 fw-bolder fs-6 lh-1">تی شرت</span>
                                    <!--end::Subtitle-->
                                    <!--begin::Bullet-->
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6">
                                ...
                                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                    ...
                                    <!--begin::Icon-->
                                    <div class="nav-icon">
                                        <img alt="" src="/public/admin/media/svg/products-categories/gaming.svg"
                                            class="">
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <span class="nav-text text-gray-700 fw-bolder fs-6 lh-1">بازی</span>
                                    <!--end::Subtitle-->
                                    <!--begin::Bullet-->
                                    <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                    <!--end::Bullet-->
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6">
                                ...
                                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                    ...
                                    <!--begin::Icon-->
                                    <div class="nav-icon">
                                        <img alt="" src="/public/admin/media/svg/products-categories/watch.svg"
                                            class="">
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <span class="nav-text text-gray-600 fw-bolder fs-6 lh-1">ساعت</span>
                                    <!--end::Subtitle-->
                                    <!--begin::Bullet-->
                                    <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                    <!--end::Bullet-->
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6">
                                ...
                                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                    ...
                                    <!--begin::Icon-->
                                    <div class="nav-icon">
                                        <img alt="" src="/public/admin/media/svg/products-categories/gloves.svg"
                                            class="nav-icon">
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <span class="nav-text text-gray-600 fw-bolder fs-6 lh-1">دستکش</span>
                                    <!--end::Subtitle-->
                                    <!--begin::Bullet-->
                                    <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                    <!--end::Bullet-->
                            ...
                            <li class="nav-item mb-3">
                                ...
                                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                    ...
                                    <!--begin::Icon-->
                                    <div class="nav-icon">
                                        <img alt="" src="/public/admin/media/svg/products-categories/shoes.svg"
                                            class="nav-icon">
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <span class="nav-text text-gray-600 fw-bolder fs-6 lh-1">کفش ها</span>
                                    <!--end::Subtitle-->
                                    <!--begin::Bullet-->
                                    <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                    <!--end::Bullet-->
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <thead>
                                            <tr class="fs-7 fw-bolder text-gray-500 border-bottom-0">
                                                <th class="ps-0 w-50px">مورد</th>
                                                <th class="min-w-140px"></th>
                                                <th class="text-end min-w-140px">مقدار</th>
                                                <th class="pe-0 text-end min-w-120px">قیمت</th>
                                                <th class="pe-0 text-end min-w-120px">قیمت کل</th>
                                            </tr>
                                        </thead>
                                        <!--end::Table head-->
                                        <!--begin::Table body-->
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/210.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                                        class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">فیل
                                                        1802</a>
                                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">آیتم:
                                                        #XDG-2347</span>
                                                </td>
                                                <td>
                                                    <span
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/215.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                                        class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">لباس
                                                        قرمز</a>
                                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">آیتم:
                                                        #XDG-1321</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/209.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                                        class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">لباس</a>
                                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">آیتم:
                                                        #XDG-4312</span>
                                                </td>
                                                <td>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/197.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/178.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/22.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/1.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/24.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/71.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/41.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/63.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/59.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/10.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                                        class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">نایک</a>
                                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">آیتم:
                                                        #XDG-2163</span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/96.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                                        class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">آدیداس</a>
                                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">آیتم:
                                                        #XDG-2162</span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="/public/admin/media/stock/ecommerce/13.gif"
                                                        class="w-50px ms-n1" alt="">
                                                </td>
                                                <td class="ps-0">
                                                    <a href="../apps/ecommerce/catalog/edit-product.html"
                                                        class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">پوما</a>
                                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">آیتم:
                                                        #XDG-1537</span>
                                                </td>
                                                <td>
            ...
            <div class="col-xl-6 mb-5 mb-xl-10">
                ...
                <div class="card card-flush overflow-hidden h-md-100">
                    ...
                    <div class="card-header py-5">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">فروش محصولات با تخفیف</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">کاربران از تمامی کانال ها</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                    ...
                    <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                        ...
                        <div class="px-9 mb-5">
                            ...
                            <!--end::امار-->
                            <!--begin::توضیحات-->
                            <span class="fs-6 fw-bold text-gray-400">کل تخفیف فروش این ماه</span>
                            <!--end::توضیحات-->
                        </div>
                        <!--end::Info-->
                        <!--begin::Chart-->
            ...
            <div class="col-xl-4 mb-xl-10">
                ...
                <div class="card h-md-100">
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="mb-2">
                            <!--begin::Title-->
                            <h1 class="fw-bold text-gray-800 text-center lh-lg">آیا سعی کرده ای
                                <br>new
                                <span class="fw-boldest">اپلیکیشن تجاری؟</span>
                            </h1>
                            <!--end::Title-->
                            <!--begin::Illustration-->
                            <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 my-lg-12"
                                style="background-image:url('/public/admin/media/svg/illustrations/easy/2.svg')"></div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Links-->
                        <div class="text-center mb-1">
                            <!--begin::Link-->
                            <a class="btn btn-sm btn-primary me-2" href="../apps/ecommerce/sales/listing.html">نمایش
                                اپلیکیشن</a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a class="btn btn-sm btn-light" href="../apps/ecommerce/catalog/add-product.html">جدید
                                محصولات</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Links-->
            ...
            <div class="col-xl-8 mb-5 mb-xl-10">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header pt-7">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-gray-800">محصولات سفارشات</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">میانگین سفارشات روزانه</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Actions-->
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-4">
                                ...
                                <div class="d-flex align-items-center fw-bolder">
                                    ...
                                    <select
                                        ...
                                        data-control="select2" data-hide-search="true" data-dropdown-css-class="w-150px"
                                        data-placeholder="انتخاب " data-kt-table-widget-4="filter_status">
                                        <option></option>
                                        <option value="مشاهده همه" selected="selected">مشاهده همه</option>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    <th class="min-w-100px">شناسه سفارش</th>
                                    <th class="text-end min-w-100px">زمان ایجاد</th>
                                    <th class="text-end min-w-125px">مشتری</th>
                                    <th class="text-end min-w-100px">کل</th>
                                    <th class="text-end min-w-100px">سود</th>
                            ...
                            <tbody class="fw-bolder text-gray-600">
                                    ...
                                    <td colspan="2">
                                        <div class="d-flex align-items-center gap-3">
                                            <a href="#"
                                                ...
                                                <img src=""
                                                    data-kt-src-path="/public/admin/media/stock/ecommerce/" alt=""
                                            ...
                                            <div class="d-flex flex-column text-muted">
                                                ...
                                                <div class="fs-7" data-kt-table-widget-4="template_description">محصولات
                                                    description</div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">7 دقیقه قبل</td>
                                    <td class="text-end">
                                        <a href="#" class="text-gray-600 text-hover-primary">آرش موحدی</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">52 دقیقه قبل</td>
                                    <td class="text-end">
                                        <a href="#" class="text-gray-600 text-hover-primary">ویلسون</a>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <span class="badge py-3 px-4 fs-7 badge-light-primary">تایید شده</span>
                                    </td>
                                    <td class="text-end">
                                        <button type="button"
                                            class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px"
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">1 ساعت قبل</td>
                                    <td class="text-end">
                                        <a href="#" class="text-gray-600 text-hover-primary">رابرت فاکس</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">3 ساعت قبل</td>
                                    <td class="text-end">
                                        <a href="#" class="text-gray-600 text-hover-primary">کامران</a>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <span class="badge py-3 px-4 fs-7 badge-light-success">ارسال شد</span>
                                    </td>
                                    <td class="text-end">
                                        <button type="button"
                                            class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px"
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">دو روز پیش</td>
                                    <td class="text-end">
                                        <a href="#" class="text-gray-600 text-hover-primary">عارف لرستانی</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">دو روز پیش</td>
                                    <td class="text-end">
                                        <a href="#" class="text-gray-600 text-hover-primary">الیاس صبوری</a>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <span class="badge py-3 px-4 fs-7 badge-light-danger">رد شد</span>
                                    </td>
                                    <td class="text-end">
                                        <button type="button"
                                            class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px"
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">7 دقیقه قبل</td>
                                    <td class="text-end">
                                        <a href="#" class="text-gray-600 text-hover-primary">علی کاربر</a>
                                    </td>
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header pt-7">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">محصولات تحویل</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">1 میلیون محصول تا کنون ارسال شده است</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                        <div class="card-toolbar">
                            <a href="../apps/ecommerce/sales/details.html" class="btn btn-sm btn-light">جزییات
                                سفارش</a>
                        </div>
                        <!--end::Toolbar-->
                    </div>
                        ...
                        <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                            ...
                            <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                ...
                                <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="me-3">
                                        <!--begin::Icon-->
                                        <img src="/public/admin/media/stock/ecommerce/210.gif" class="w-50px ms-n1 me-1"
                                            alt="">
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <a href="../apps/ecommerce/catalog/edit-product.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">فیل 1802</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Wrapper-->
                                    <!--begin::Actions-->
                                    <div class="m-0">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px"
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <div class="menu-content fs-6 text-dark fw-bolder px-3 py-4">عملیات
                                                    سریع
                                                </div>
                                            </div>
                                            <!--end::Menu item-->
                                            ...
                                            <div class="menu-item px-3">
                                                <div class="menu-content px-3 py-3">
                                                    <a class="btn btn-primary btn-sm px-4" href="#">گزارش ایجاد
                                                        کنید</a>
                                                </div>
                                            </div>
                                            <!--end::Menu item-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::نام-->
                                    <span class="text-gray-400 fw-bolder">به:
                                        <a href="../apps/ecommerce/sales/details.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">جیسون بورن</a></span>
                                    <!--end::نام-->
                                    <!--begin::Tags-->
                            ...
                            <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                ...
                                <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="me-3">
                                        <!--begin::Icon-->
                                        <img src="/public/admin/media/stock/ecommerce/209.gif" class="w-50px ms-n1 me-1"
                                            alt="">
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <a href="../apps/ecommerce/catalog/edit-product.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">لباس</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Wrapper-->
                                    <!--begin::Actions-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <span class="text-gray-400 fw-bolder">به:
                                        <a href="../apps/ecommerce/sales/details.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">دورانت</a></span>
                                    <!--end::نام-->
                                    <!--begin::Tags-->
                            ...
                            <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                ...
                                <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="me-3">
                                        <!--begin::Icon-->
                                        <img src="/public/admin/media/stock/ecommerce/214.gif" class="w-50px ms-n1 me-1"
                                            alt="">
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <a href="../apps/ecommerce/catalog/edit-product.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">تی شرت زرد</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Wrapper-->
                                    <!--begin::Actions-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <span class="text-gray-400 fw-bolder">به:
                                        <a href="../apps/ecommerce/sales/details.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">علی کاربر</a></span>
                                    <!--end::نام-->
                                    <!--begin::Tags-->
                            ...
                            <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                ...
                                <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="me-3">
                                        <!--begin::Icon-->
                                        <img src="/public/admin/media/stock/ecommerce/211.gif" class="w-50px ms-n1 me-1"
                                            alt="">
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <a href="../apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <span class="text-gray-400 fw-bolder">به:
                                        <a href="../apps/ecommerce/sales/details.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">محمد ابراهیمی</a></span>
                                    <!--end::نام-->
                                    <!--begin::Tags-->
                                    <span class="badge badge-light-success">سفارش داده شده</span>
                                    <!--end::Tags-->
                            ...
                            <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                ...
                                <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="me-3">
                                        <!--begin::Icon-->
                                        <img src="/public/admin/media/stock/ecommerce/215.gif" class="w-50px ms-n1 me-1"
                                            alt="">
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <a href="../apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <span class="text-gray-400 fw-bolder">به:
                                        <a href="../apps/ecommerce/sales/details.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">محمد رضایی</a></span>
                                    <!--end::نام-->
                                    <!--begin::Tags-->
                                    <span class="badge badge-light-primary">حمل دریایی</span>
                                    <!--end::Tags-->
                            ...
                            <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3">
                                ...
                                <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="me-3">
                                        <!--begin::Icon-->
                                        <img src="/public/admin/media/stock/ecommerce/192.gif" class="w-50px ms-n1 me-1"
                                            alt="">
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <a href="../apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <span class="text-gray-400 fw-bolder">به:
                                        <a href="../apps/ecommerce/sales/details.html"
                                            class="text-gray-800 text-hover-primary fw-bolder">اتنا رضایی</a></span>
                                    <!--end::نام-->
                                    <!--begin::Tags-->
                                    <span class="badge badge-light-danger">تایید شده</span>
                                    <!--end::Tags-->
            ...
            <div class="col-xl-8">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header pt-7">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">گزارش استوک</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">کل 2,356 قلم موجود در انبار</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Actions-->
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-4">
                                ...
                                <!--end::وضعیت-->
                                <!--begin::جستجو-->
                                <a href="../apps/ecommerce/catalog/products.html" class="btn btn-light btn-sm">نمایش
                                </a>
                                <!--end::جستجو-->
                            </div>
                            <!--begin::فیلترها-->
                            ...
                            <tbody class="fw-bolder text-gray-600">
                                <tr>
                                    ...
                                    <td class="text-end" data-order="58">
                                        <span class="text-dark fw-bolder">58 مورد</span>
                                    </td>
                                    <!--end::تعداد-->
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end" data-order="0">
                                        <span class="text-dark fw-bolder">0 مورد</span>
                                    </td>
                                    <!--end::تعداد-->
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end" data-order="290">
                                        <span class="text-dark fw-bolder">290 مورد</span>
                                    </td>
                                    <!--end::تعداد-->
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end" data-order="46">
                                        <span class="text-dark fw-bolder">46 مورد</span>
                                    </td>
                                    <!--end::تعداد-->
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end" data-order="78">
                                        <span class="text-dark fw-bolder">78 مورد</span>
                                    </td>
                                    <!--end::تعداد-->
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../apps/ecommerce/catalog/edit-product.html"
                                            class="text-dark text-hover-primary">Dell 32</a>
                                    </td>
                                    <!--end::Item-->
                                    <!--begin::محصولات شناسه-->
                                    <td class="text-end">#XGY-356</td>
                                    ...
                                    <td class="text-end" data-order="8">
                                        <span class="text-dark fw-bolder">8 مورد</span>
                                    </td>
                                    <!--end::تعداد-->
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../apps/ecommerce/catalog/edit-product.html"
                                            class="text-dark text-hover-primary"> Pixel 6 </a>
                                    </td>
                                    <!--end::Item-->
                                    <!--begin::محصولات شناسه-->
                                    ...
                                    <td class="text-end" data-order="124">
                                        <span class="text-dark fw-bolder">124 مورد</span>
                                    </td>
                                    <!--end::تعداد-->
                                </tr>
                            </tbody>
...
@section('page-vendor-scripts')
    <script src="/public/admin/plugins/custom/datatables/datatables.bundle.js"></script>
    <script src="/public/admin/plugins/custom/vis-timeline/vis-timeline.bundle.js"></script>
@endsection
