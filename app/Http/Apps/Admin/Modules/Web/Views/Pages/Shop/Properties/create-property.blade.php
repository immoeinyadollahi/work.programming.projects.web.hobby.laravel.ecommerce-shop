...
@section('page-title', 'افزودن ویژگی')
@section('page-toolbar-title', 'افزودن ویژگی')
@section('page-toolbar-breadcrumb')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-dark">افزودن ویژگی</li>
    <!--end::Item-->
@endsection
    ...
    <div id="kt_content_container" class="container-fluid">
        <form class="form d-flex flex-column flex-row-fluid gap-7 gap-lg-10" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="fv-row fv-plugins-icon-container">
                        ...
                        <input type="text" name="name"
                            ...
                            placeholder="نام ویژگی" value="{{ old('name') }}">
                        <!--end::Input-->
                        @error('name')
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="/shop/property-group/{{ $group->id }}/properties" class="btn btn-light me-5">انصراف</a>
                <!--end::Button-->
                <!--begin::Button-->
