...
<head>
    ...
    <link href="{{ _mix('/css/style.css') }}" rel="stylesheet" type="text/css">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="../index.html">
                        <img alt="Logo" src="/public/admin/media/logos/logo-1-dark.svg" class="h-25px logo">
                    </a>
                    <!--end::Logo-->
                    <!--begin::کناری toggler-->
                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/basic/sign-in.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/basic/sign-up.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/basic/two-steps.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/basic/password-reset.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/basic/new-password.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/aside/sign-in.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">ورود</span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/aside/sign-up.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">ثبت نام</span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/aside/two-steps.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">دو مرحله ای</span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/aside/password-reset.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">ریست کلمه عبور</span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/aside/new-password.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">کلمه عبور جدید</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/dark/two-steps.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">دو مرحله ای</span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/dark/password-reset.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">ریست کلمه عبور</span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../authentication/layouts/dark/new-password.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">کلمه عبور جدید</span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            href="../authentication/extended/two-factor-authentication.html">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="../authentication/email/invitation.html"
                                                    target="blank">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                            ...
                            <div class="menu-item">
                                <div class="menu-content pt-8 pb-2">
                                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">اپلیکیشن ها</span>
                                </div>
                            </div> --}}
                            {{-- <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            <div class="menu-item">
                                                <a class="menu-link" href="/shop/products">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="/shop/products/create">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                            ...
                            <div class="menu-item">
                                <div class="menu-content pt-8 pb-0">
                                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">قالب بندی</span>
                                </div>
                            </div>
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/toolbars/toolbar-1.html">
                                            ...
                                            <span class="menu-title">نوار ابزار 1</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/toolbars/toolbar-2.html">
                                            ...
                                            <span class="menu-title">نوار ابزار 2</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/toolbars/toolbar-3.html">
                                            ...
                                            <span class="menu-title">نوار ابزار 3</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/toolbars/toolbar-4.html">
                                            ...
                                            <span class="menu-title">نوار ابزار 4</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/toolbars/toolbar-5.html">
                                            ...
                                            <span class="menu-title">نوار ابزار 5</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/toolbars/no-toolbar.html">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">بدون نوار ابزار</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">کناری</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/aside/font-icons.html">
                                            ...
                                            <span class="menu-title">ایکون ها</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/aside/minimized.html">
                                            ...
                                            <span class="menu-title">به حداقل رساندن</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../layouts/aside/only-header.html">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">فقط هدر</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="../../../../../metronic8/demo1/layout-builder.html"
                                    title="طرح بندی خود را بسازید و HTML را برای ادغام سمت سرور صادر کنید"
                ...
                {{-- <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
                    <a href="#" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip"
                        data-bs-trigger="hover" data-bs-dismiss-="click" title="200+ کامپوننت ها و افزونه های شخص ثالث">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="../index.html" class="d-lg-none">
                                <img alt="Logo" src="/public/admin/media/logos/logo-2.svg" class="h-30px">
                            </a>
                        </div>
                        <!--end::Mobile logo-->
                        <!--begin::Wrapper-->
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link active py-3" href="ecommerce.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">فروشگاه</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="projects.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">پروژه ها</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="online-courses.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">آنلاین دوره ها</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="marketing.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">بازاریابی</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="bidding.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">مناقصه</span>
                                                ...
                                                <div class="menu-inner flex-column collapse"
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="logistics.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">حمل و نقل</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="delivery.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">تحویل</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="website-analytics.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">وب سایت آنالیتیکس</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="finance-performance.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">عملکرد مالی</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="store-analytics.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">فروشگاه آنالیتیکس</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="social.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">شبکه اجتماعی</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="crypto.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">کریپتو</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="school.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">مدرسه</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link py-3" href="podcast.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">پادکست</span>
                                        ...
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
                                            class="menu-item menu-lg-down-accordion me-lg-1">
                                            <span class="menu-link py-3">
                                                <span class="menu-title">ساخته شده</span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </span>
                                            <div
                                                class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                                    ...
                                                    <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">صفحه تکی
                                                                            مقالات</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../pages/pricing/pricing-1.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">قیمت گذاری
                                                                            1</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../pages/pricing/pricing-2.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">قیمت گذاری
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3" href="../pages/contact.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">تماس با ما</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3" href="../pages/team.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">تیم ما</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3" href="../pages/licenses.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">مجوزها</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3" href="../pages/sitemap.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">نقشه سایت</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3" href="../account/logs.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">گزارش</span>
                                                    ...
                                                    <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">ریست کلمه
                                                                            عبور</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">کلمه عبور
                                                                            جدید</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../authentication/layouts/dark/sign-in.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">ورود</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../authentication/layouts/dark/sign-up.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">ثبت نام</span>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">احراز هویت دومرحله
                                                                            ای</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">ثبت نام چند مرحله
                                                                            ای</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">رایگان آزمایش ثبت
                                                                            نام</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">پیام خوش امد
                                                                            گویی</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">تایید کلمه
                                                                            عبور</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title"> تعویض کلمه عبور
                                                                        </span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="menu-item">
                                                                            <a class="menu-link py-3"
                                                                                ...
                                                                                <span class="menu-title">آدرس های
                                                                                    جدید</span>
                                                                            </a>
                                                                        </div>
                                                                        <div class="menu-item">
                                                                            <a class="menu-link py-3"
                                                                                ...
                                                                                <span class="menu-title">ساختن ای
                                                                                    پی
                                                                                    آی</span>
                                                                            </a>
                                                                        </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="menu-item">
                                                                            <a class="menu-link py-3"
                                                                                ...
                                                                                <span class="menu-title">احراز هویت
                                                                                    دومرحله ای</span>
                                                                            </a>
                                                                        </div>
                                                                        <div class="menu-item">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">دسته بندی
                                                                            ها</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">افزودن دسته
                                                                            بندی</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                            ...
                                                            <div class="menu-sub menu-sub-accordion">
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">محصولات مشاهده
                                                                            شده</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">سطح دسترسی
                                                                            لیست</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">نمایش سطح
                                                                            دسترسی</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/toolbars/toolbar-1.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">نوار ابزار 1</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/toolbars/toolbar-2.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">نوار ابزار 2</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/toolbars/toolbar-3.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">نوار ابزار 3</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/toolbars/toolbar-4.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">نوار ابزار 4</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/toolbars/toolbar-5.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">نوار ابزار 5</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/toolbars/no-toolbar.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">بدون نوار ابزار</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/aside/font-icons.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">ایکون ها</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/aside/minimized.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">به حداقل رساندن</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../layouts/aside/only-header.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">فقط هدر</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="../../../../../metronic8/demo1/layout-builder.html"
                                                        title="طرح خود را بسازید ، HTML را برای ادغام سمت سرور نمایش داده و صادر کنید"
                                        ...
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
                                            class="menu-item menu-lg-down-accordion me-lg-1">
                                            <span class="menu-link py-3">
                                                <span class="menu-title">منابع</span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </span>
                                            <div
                                                class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="../../demo1/dist/documents/base/utilities.html"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="#"
                                                        title="اسناد کامل را بررسی کنید" data-bs-toggle="tooltip"
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                    ...
                                    <div id="kt_header_search" class="header-search d-flex align-items-stretch"
                                        ...
                                        <div data-kt-search-element="content"
                                            ...
                                            <div data-kt-search-element="wrapper">
                                                    ...
                                                    <div class="scroll-y mh-200px mh-lg-350px">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="/public/admin/media/avatars/300-6.jpg"
                                                                    alt="">
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                            <div
                                                                ...
                                                                <span class="fs-7 fw-bold text-muted">مدیریت
                                                                    بازاریابی</span>
                                                            </div>
                                                            <!--end::Title-->
                                                        </a>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <!--begin::Symbol-->
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="/public/admin/media/avatars/300-2.jpg"
                                                                    alt="">
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                            <div
                                                                ...
                                                                <span class="fs-7 fw-bold text-muted">مهندس نرم
                                                                    افزار</span>
                                                            </div>
                                                            <!--end::Title-->
                                                        </a>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <!--begin::Symbol-->
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="/public/admin/media/avatars/300-9.jpg"
                                                                    alt="">
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                            <div
                                                                ...
                                                                <span class="fs-7 fw-bold text-muted">طراح یو ای و
                                                                    یوایکس</span>
                                                            </div>
                                                            <!--end::Title-->
                                                        </a>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <!--begin::Symbol-->
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="/public/admin/media/avatars/300-14.jpg"
                                                                    alt="">
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                            <div
                                                                ...
                                                                <span class="fs-7 fw-bold text-muted">کارگردان
                                                                    هنری</span>
                                                            </div>
                                                            <!--end::Title-->
                                                        </a>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <!--begin::Symbol-->
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="/public/admin/media/avatars/300-11.jpg"
                                                                    alt="">
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <span class="symbol-label bg-light">
                                                                    <img class="w-20px h-20px"
                                                                        src="/public/admin/media/svg/brand-logos/volicity-9.svg"
                                                                        alt="">
                                                                </span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <span class="symbol-label bg-light">
                                                                    <img class="w-20px h-20px"
                                                                        src="/public/admin/media/svg/brand-logos/tvit.svg"
                                                                        alt="">
                                                                </span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            ...
                                                            <div
                                                                ...
                                                                <span class="fs-7 fw-bold text-muted">توسعه دهنده
                                                                    وب</span>
                                                            </div>
                                                            <!--end::Title-->
                                                        </a>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <span class="symbol-label bg-light">
                                                                    <img class="w-20px h-20px"
                                                                        src="/public/admin/media/svg/misc/infography.svg"
                                                                        alt="">
                                                                </span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            ...
                                                            <div
                                                                class="d-flex flex-column justify-content-start fw-bold">
                                                                <span class="fs-6 fw-bold">بیزینس آنالیتیکس
                                                                    اپلیکیشن</span>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <span class="symbol-label bg-light">
                                                                    <img class="w-20px h-20px"
                                                                        src="/public/admin/media/svg/brand-logos/leaf.svg"
                                                                        alt="">
                                                                </span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            ...
                                                            <div
                                                                class="d-flex flex-column justify-content-start fw-bold">
                                                                <span class="fs-6 fw-bold">اکولیف اپلیکیشن
                                                                    لانچ</span>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <span class="symbol-label bg-light">
                                                                    <img class="w-20px h-20px"
                                                                        src="/public/admin/media/svg/brand-logos/tower.svg"
                                                                        alt="">
                                                                </span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            ...
                                                            <div
                                                                ...
                                                                <span class="fs-7 fw-bold text-muted">گوگل
                                                                    Adwords</span>
                                                            </div>
                                                            <!--end::Title-->
                                                        </a>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <span class="fs-6 fw-bold">پروژه توسط ساتراس
                                                                    وب</span>
                                                ...
                                                <div class="mb-5" data-kt-search-element="main">
                                                    ...
                                                    <div class="scroll-y mh-200px mh-lg-325px">
                                                        ...
                                                        <div class="d-flex align-items-center mb-5">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <a href="#"
                                                                    class="fs-6 text-gray-800 text-hover-primary fw-bold">ساتراس
                                                                    وب</a>
                                                        ...
                                                        <div class="d-flex align-items-center mb-5">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <a href="#"
                                                                    class="fs-6 text-gray-800 text-hover-primary fw-bold">"صفحه
                                                                    فرود طراح" لانچ</a>
                                                ...
                                                <div data-kt-search-element="empty" class="text-center d-none">
                                                    ...
                                                    <div class="pb-15 fw-bold">
                                                        ...
                                                        <div class="text-muted fs-7">لطفاً با یک پرسش دیگر دوباره
                                                            امتحان
                                                            کنید</div>
                                                    </div>
                                                    <!--end::Message-->
                                            ...
                                            <form data-kt-search-element="advanced-options-form"
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <select name="timezone" aria-label="انتخاب زمان محلی"
                                            ...
                                            <form data-kt-search-element="preferences" class="pt-1 d-none">
                                                ...
                                                <div class="pb-4 border-bottom">
                                                    <label
                                                        ...
                                                        <span
                                                            class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">پروژه
                                                            ها</span>
                                                ...
                                                <div class="py-4 border-bottom">
                                                    <label
                                                        class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                                        <span
                                                            class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">برنامه
                                                            بازاریابی</span>
                                                        <input class="form-check-input" type="checkbox"
                                                            value="1">
                                                    </label>
                                                ...
                                                <div class="d-flex justify-content-end pt-7">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-sm fw-bolder btn-primary">ذخیره
                                                        تغییرات</button>
                                                </div>
                                                <!--end::Actions-->
                                            </form>
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                        ...
                                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                            style="background-image:url('/public/admin/media/misc/pattern-1.jpg')">
                                            <!--begin::Title-->
                                            ...
                                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-bold px-9">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active"
                                                        data-bs-toggle="tab"
                                                        href="#kt_topbar_notifications_2">بروزرسانی
                                                        ها</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                                        data-bs-toggle="tab"
                                                        href="#kt_topbar_notifications_3">گزارش</a>
                                                </li>
                                            </ul>
                                            <!--end::Tabs-->
                                        </div>
                                            ...
                                            <div class="tab-pane fade" id="kt_topbar_notifications_1"
                                                ...
                                                <div class="scroll-y mh-325px my-5 px-8">
                                                    ...
                                                    <div class="d-flex flex-stack py-4">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="mb-0 me-2">
                                                                <a href="#"
                                                                    class="fs-6 text-gray-800 text-hover-primary fw-bolder">کمپانی
                                                                    HR</a>
                                                ...
                                                <div class="py-3 text-center border-top">
                                                    <a href="../pages/user-profile/activity.html"
                                                        class="btn btn-color-gray-600 btn-active-color-primary">نمایش
                                                        همه
                                                ...
                                                <div class="d-flex flex-column px-9">
                                                    ...
                                                    <div class="pt-10 pb-0">
                                                        ...
                                                        <div class="text-center text-gray-600 fw-bold pt-1">رئوس مطالب
                                                            ...
                                                            درمورد رانندگی را می گیرند</div>
                                                        <!--end::Text-->
                                                        <!--begin::Actions-->
                                                    ...
                                                    <div class="text-center px-4">
                                                        <img class="mw-100 mh-200px" alt="image"
                                                            src="/public/admin/media/illustrations/sketchy-1/1.png">
                                                    </div>
                                                    <!--end::Illustration-->
                                                </div>
                                                <!--end::Wrapper-->
                                                ...
                                                <div class="scroll-y mh-325px my-5 px-8">
                                                    ...
                                                    <div class="d-flex flex-stack py-4">
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            <!--begin::Code-->
                                                            <span
                                                                class="w-70px badge badge-light-success me-4">200</span>
                                                            <!--end::Code-->
                                                            <!--begin::Title-->
                                                            <a href="#"
                                                    ...
                                                    <div class="d-flex flex-stack py-4">
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            <!--begin::Code-->
                                                            <span
                                                                class="w-70px badge badge-light-danger me-4">500</span>
                                                            <!--end::Code-->
                                                            <!--begin::Title-->
                                                            <a href="#"
                                                    ...
                                                    <div class="d-flex flex-stack py-4">
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            <!--begin::Code-->
                                                            <span
                                                                class="w-70px badge badge-light-warning me-4">300</span>
                                                            <!--end::Code-->
                                                            <!--begin::Title-->
                                                            <a href="#"
                                                    ...
                                                    <div class="d-flex flex-stack py-4">
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <!--begin::Title-->
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary fw-bold">بازیابی
                                                                دیتابیس</a>
                                                            <!--end::Title-->
                                                        </div>
                                                        <!--end::بخش-->
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                                        ...
                                        <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                                            ...
                                            <!--end::Title-->
                                            <!--begin::وضعیت-->
                                            <span class="badge bg-primary py-2 px-3">25 وظیفه در انتظار</span>
                                            <!--end::وضعیت-->
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin:Nav-->
                                        <div class="row g-0">
                                            ...
                                            <div class="col-6">
                                                <a href="../apps/projects/users.html"
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <span class="fs-5 fw-bold text-gray-800 mb-0">مشتریان</span>
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                        data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                        data-kt-menu-placement="bottom-end">
                                        <img src="/public/admin/media/avatars/300-1.jpg" alt="user">
                                    </div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="Logo" src="/public/admin/media/avatars/300-1.jpg">
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::کاربرname-->
                                                <div class="d-flex flex-column">
                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../account/referrals.html"
                                                        class="menu-link px-5">مراجعات</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="../account/billing.html"
                                                        class="menu-link px-5">صورتحساب</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="../account/statements.html"
                                                        class="menu-link px-5">درگاه
                                                        ها</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                    ...
                                                    <div class="menu-content px-3">
                                                        <label
                                                            ...
                                                            <input class="form-check-input w-30px h-20px"
                                                                ...
                                                                name="notifications">
                                                            <span class="form-check-label text-muted fs-7">اعلان
                                                                ها</span>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="../account/statements.html" class="menu-link px-5">من بیانه
                                                ها</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu separator-->
                                                ...
                                                <span class="menu-title position-relative">زبان
                                                    <span
                                                        ...
                                                        <img class="w-15px h-15px rounded-1 ms-2"
                                                            src="/public/admin/media/flags/united-states.svg"
                                                            alt=""></span></span>
                                            </a>
                                            <!--begin::Menu sub-->
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="/public/admin/media/flags/spain.svg"
                                                                alt="">
                                                        </span>اسپانیایی</a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="/public/admin/media/flags/germany.svg"
                                                                alt="">
                                                        </span>آلمانی</a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="/public/admin/media/flags/japan.svg"
                                                                alt="">
                                                        </span>ژاپنی</a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="/public/admin/media/flags/france.svg"
                                                                alt="">
                                                        </span>فرانسه</a>
                                                </div>
                                                <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-5 my-1">
                                            <a href="../account/settings.html" class="menu-link px-5">اکانت
                                                تنظیمات</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">@yield('page-toolbar-title')
                                </h1>
                                <!--end::Title-->
                                @hasSection('page-toolbar-breadcrumb')
                                    <!--begin::Separator-->
                                    <span class="h-20px border-gray-300 border-start mx-4"></span>
                                    <!--end::Separator-->
                                    <!--begin::Breadcrumb-->
                                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                        @yield('page-toolbar-breadcrumb')
                                    </ul>
                                    <!--end::Breadcrumb-->
                                @endif
                            </div>
                    ...
                    @if (session()->has('messages'))
                        <div class="container alert-container js-alert-container">
                            @foreach (session()->get('messages') as $item)
                                <!--begin::Alert-->
                                <div
                                    class="alert alert-{{ $item['level'] }} d-flex align-items-center justify-content-between p-4">
                                    <!--begin::Wrapper-->
                                    <!--begin::Title-->
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    <!--begin::Title-->
                                    <div class="fs-5 fw-bold mb-2">در پروژه اپلیکیشن موبایل کار جدید برای شما وجود دارد:
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::توضیحات-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="/public/admin/media/avatars/300-14.jpg" alt="img">
                                        </div>
                                        <!--end::user-->
                                    </div>
                                    <!--end::توضیحات-->
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="/public/admin/media/avatars/300-2.jpg" alt="img">
                                            </div>
                                            <!--end::user-->
                                            <!--begin::user-->
                                            <div class="symbol symbol-circle symbol-25px">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::user-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="/public/admin/media/avatars/300-20.jpg" alt="img">
                                            </div>
                                            <!--end::user-->
                                            <!--begin::user-->
                                            <div class="symbol symbol-circle symbol-25px">
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="/public/admin/media/avatars/300-1.jpg" alt="img">
                                        </div>
                                        <!--end::user-->
                                    </div>
                                    <!--end::توضیحات-->
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="/public/admin/media/avatars/300-23.jpg" alt="img">
                                        </div>
                                        <!--end::user-->
                                    </div>
                                    <!--end::توضیحات-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="" class="w-30px me-3" src="/public/admin/media/svg/files/pdf.svg">
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                                <a href="apps/projects/project.html"
                                                    class="fs-6 text-hover-primary fw-bolder">اپلیکیشن مالی</a>
                                                <!--end::Desc-->
                                                <!--begin::شماره کارت-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="/public/admin/media/svg/files/doc.svg">
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                                <a href="#" class="fs-6 text-hover-primary fw-bolder">مشتری نتایج
                                                    تست</a>
                                                <!--end::Desc-->
                                                <!--begin::شماره کارت-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="/public/admin/media/svg/files/css.svg">
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="fs-5 fw-bold mb-2">وظیفه
                                        ...
                                        <a href="#" class="text-primary fw-bolder me-1">#45890</a>داشبورد پروژه ها:
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::توضیحات-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="/public/admin/media/stock/600x400/img-29.jpg">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="/public/admin/media/stock/600x400/img-31.jpg">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="/public/admin/media/stock/600x400/img-40.jpg">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="fs-5 fw-bold mb-2">کیس جدید
                                        <a href="#" class="text-primary fw-bolder me-1">#67890</a>در پروژه طراحی دیتابیس
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="/public/admin/media/avatars/300-4.jpg" alt="img">
                                        </div>
                                        <!--end::user-->
                                    </div>
                                    <!--end::توضیحات-->
                            ...
                            <div class="timeline-content mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="fs-5 fw-bold mb-2">سفارش جدید
                                        <a href="#" class="text-primary fw-bolder me-1">#67890</a>برای برآورد پلان و
                                        بودجه قرار داده شده است
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::توضیحات-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="/public/admin/media/avatars/300-25.jpg">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="/public/admin/media/avatars/300-1.jpg">
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::user-->
                    ...
                    <div class="d-flex justify-content-start mb-10">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start"
                                ...
                                کنید:
                                <a href="../../../../index.htm">satrasweb.ir</a>
                            </div>
                            <!--end::Text-->
                        </div>
                        <!--end::Wrapper-->
