...
class AttributesController extends Controller
{
    public function postAttribute($product_id)
    {
        ...
        return ["attribute" => $product->variableTypeAttributes()->where("attributes.id", $attribute_id)->first()];
    }
    ...
    public function patchValues($product_id, $attribute_id)
    {
        ...
        $product_attribute = $product->variableTypeAttributes()->where("attributes.id", $attribute_id)->first();
        ...
        $product->variableTypeVariations()->get()->each(function ($variation) use ($values, $attribute_id) {
            $attribute =  $variation->variableProductTypeAttributes()->where("attributes.id", $attribute_id)->first();
